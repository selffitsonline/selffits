  ...
  const stories = [
    {
      ...
      quote: "SELFFITS changed my 12-year-old son's routine completely. He passed his Blue Belt evaluation right from our living room! Sensei Rahul corrects every kick posture live.",
    ...
    },
    {
      ...
      quote: "The 24 Day Weight Loss Challenge helped me lose 6 kg while boosting my stamina. Having a live coach watch my form prevented any back pain.",
    ...
    },
    {
      ...
      achievement: "Purple Belt Candidate",
