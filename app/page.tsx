  ...
  return (
    <div className="min-h-screen bg-[#0A0B0E] text-white flex flex-col selection:bg-[#E50914] selection:text-white">
      ...
      <main className="flex-grow pt-20">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            >
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
                <Link
                  href="/membership"
                  className="px-8 py-4 rounded-xl bg-gradient-to-r from-[#E50914] to-[#FF1E27] text-white font-bold text-base hover:opacity-95 transition-all shadow-xl shadow-[#E50914]/25 hover:translate-y-[-2px] flex items-center gap-2"
                >
                  Join Academy Now
                ...
                <Link
                  href="/programs"
                  className="px-8 py-4 rounded-xl bg-[#14161D] border border-white/15 text-white font-semibold text-base hover:bg-white/5 transition-all"
                >
                  View Programs
                </Link>
              </div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-[#14161D] group max-w-lg w-full">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl glass-panel flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-white">Live Class Broadcasting</h4>
                      <p className="text-xs text-gray-400">Google Meet & Zoom Active</p>
                    </div>
                  </div>
        ...
        <section className="py-20 bg-[#0E1015] border-y border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold font-[family-name:var(--font-outfit)]">
        ...
        <section className="py-24 bg-[#0E1015] border-y border-white/10 px-4">
        ...
        <section className="py-24 bg-[#0E1015] border-y border-white/10 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-[#14161D] border border-white/10 p-8 rounded-2xl relative">
                <span className="text-5xl font-black text-[#E50914]/20 absolute top-4 right-6 font-[family-name:var(--font-outfit)]">
                  01
                </span>
                <h3 className="text-lg font-bold text-white mb-2">Select Your Program</h3>
                <p className="text-xs text-gray-400 leading-relaxed">
              ...
              <div className="bg-[#14161D] border border-white/10 p-8 rounded-2xl relative">
                <span className="text-5xl font-black text-[#0080FF]/20 absolute top-4 right-6 font-[family-name:var(--font-outfit)]">
                  02
                </span>
                <h3 className="text-lg font-bold text-white mb-2">Join Live Classes</h3>
                <p className="text-xs text-gray-400 leading-relaxed">
              ...
              <div className="bg-[#14161D] border border-white/10 p-8 rounded-2xl relative">
                <span className="text-5xl font-black text-[#10B981]/20 absolute top-4 right-6 font-[family-name:var(--font-outfit)]">
                  03
                </span>
        ...
        <section className="py-24 max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((item, idx) => (
              <div key={idx} className="bg-[#14161D] border border-white/10 p-6 rounded-2xl space-y-4">
        ...
        <section className="py-24 bg-[#0E1015] border-y border-white/10 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {coaches.map((c, i) => (
                <div key={i} className="bg-[#14161D] border border-white/10 rounded-2xl overflow-hidden flex flex-col sm:flex-row items-center p-6 gap-6">
                  <div className="w-32 h-32 rounded-xl overflow-hidden relative shrink-0 border border-white/10">
                    <Image src={c.image} alt={c.name} fill className="object-cover" />
                  </div>
                  <div className="space-y-2 text-center sm:text-left">
                    <h3 className="text-lg font-bold text-white font-[family-name:var(--font-outfit)]">{c.name}</h3>
        ...
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-r from-[#E50914] via-[#DC2626] to-[#0080FF] p-10 sm:p-16 text-center space-y-6 shadow-2xl relative overflow-hidden">
            <h2 className="text-3xl sm:text-5xl font-black text-white font-[family-name:var(--font-outfit)]">
            ...
            <div className="pt-4">
              <Link
                href="/membership"
                className="px-8 py-4 rounded-xl bg-white text-[#0A0B0E] font-black text-base hover:bg-gray-100 transition-all shadow-xl inline-flex items-center gap-2"
              >
