  ...
  const notifications = [
    {
      ...
      message: "Adults Martial Arts - 3 Days / Week session starts at 7:00 PM IST on Google Meet.",
      time: "15 minutes ago",
      icon: Video,
    ...
    },
    {
      id: "notif-2",
      type: "CERTIFICATE",
      title: "Program Completion Certificate Available",
      message: "Congratulations! Your program completion certificate has been uploaded to your account.",
      time: "2 days ago",
      icon: Award,
    ...
    },
    {
      ...
      message: "Your 3 Days / Week subscription is active with 18 classes remaining.",
      time: "1 week ago",
      icon: Calendar,
