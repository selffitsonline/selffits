...
export async function getAdminHomepageManagementAction() {
  try {
    ...
    // 2.5 WHAT YOU WILL LEARN — BELT PROGRESSION SYLLABUS
    const defaultBeltSyllabusSection = {
      headingBadge: "BELT PROGRESSION SYLLABUS",
      headingTitle: "Your Martial Arts Learning Journey",
      headingSubtitle: "Explore the skills, techniques, and syllabus covered at each belt progression rank from White Belt to Black Belt.",
      belts: [
        {
          id: "white_belt",
          name: "White Belt",
    ...
    const beltSyllabusSection = settingsMap["homepage_belt_syllabus"] || defaultBeltSyllabusSection;

    // 2.6 WEIGHT MANAGEMENT JOURNEY SYLLABUS
    const defaultFitnessJourneySection = {
      headingBadge: "WEIGHT MANAGEMENT SYLLABUS",
      headingTitle: "Your Weight Management Journey",
      headingSubtitle: "Explore the core fitness, HIIT cardio, muscle endurance, and body transformation modules covered in our Weight Management program.",
      points: [
    ...
    const fitnessJourneySection = settingsMap["homepage_fitness_journey"] || defaultFitnessJourneySection;
